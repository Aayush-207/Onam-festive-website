...
const UnderDevelopment = () => {
  ...
  return (
    <section id="explore" className="section-padding bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          ...
          {/* Shopping Card */}
          <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg border border-gray-200 hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group" onClick={() => window.location.href = '/shopping'}>
